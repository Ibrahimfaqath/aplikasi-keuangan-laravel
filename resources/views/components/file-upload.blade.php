...
<div x-data="{ 
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        <button type="button" 
                ...
                class="flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 dark:bg-navy-400/10 hover:bg-blue-100 dark:hover:bg-navy-400/20 text-blue-600 dark:text-navy-300 rounded-xl border border-blue-200 dark:border-navy-400/20 font-semibold text-sm transition">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
