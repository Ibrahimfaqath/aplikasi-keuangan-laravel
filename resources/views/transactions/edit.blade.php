@php
    $title = 'Edit Transaksi - DompetKu';
    $metaDescription = 'Perbarui detail transaksi atau ganti bukti foto di DompetKu.';
...
@section('content')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <form id="tx-form" action="{{ route('transactions.update', $transaction->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
